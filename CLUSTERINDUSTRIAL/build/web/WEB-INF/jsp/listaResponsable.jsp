...
<html>
    ...
    <body onload="getData();">
        ...
        <div style="display: none;" id="dialog_add_client" title="Mantenimiento Responsable">
            <form action="" class="full validate" name="popup" id="popup">    
                ...
                <div class="row">
                    ...
                    <div>
                        <select name="txtclusteresid" id="txtclusteresid" class="search" data-placeholder="Seleccione rol usuario">
                            <c:forEach var="lisCluster" items="${listCluster}">
                ...
                <div class="row">
                    ...
                    <div>
                        <input class="required" type="date" name="txtfechainicio" id="txtfechainicio" />
                    </div>
                </div>  
                ...
                <div class="row">
                    ...
                    <div>
                        <input class="required" type="date" name="txtfechafin" id="txtfechafin" />
                    </div>
                </div>  
            </form>
            <div class="actions">
        ...
        <div role="main" id="main" class="container_12 clearfix">
            <section id="content" class="container_12 clearfix" data-sort="true">
                <form action="" class="grid_12">
                    ...
                    <legend>LISTA RESPONSABLE</legend>   
                    <div class="content">
                        <div class="tabletools">
                            <div class="left">
                                <a class="open-add-client-dialog" href="javascript:void(0);"><i class="icon-plus"></i>Nuevo Responsable</a>
                            </div>                         
                        </div>
                        <table id="list"></table> 
                        <div id="page"></div>
        ...
        <script>
            function getData() {
                $(document).ready(function() {
                    $("#list").jqGrid({
                        url: "recuperarResponsable.htm",
                        datatype: 'json',
                        height: 'auto',
                        width: 'auto',
                        colNames: ['NRO', 'SOCIO', 'CLUSTER', 'FECHA INICIO', 'FECHA FIN', 'ESTADO'],
                        colModel: [
                            {name: 'responsableid', index: 'responsableid', width: 50, sortable: false, align: 'center'},
                            ...
                            {name: 'fechainicio', index: 'fechainicio', width: 100, sortable: false, align: 'center'},
                            {name: 'fechafin', index: 'fechafin', width: 100, sortable: false, align: 'center'},
                            {name: 'estadoresponsable', index: 'estadoresponsable', width: 100, sortable: false, align: 'center', formatter: activoFormatter}
                        ],
                        multiselect: false,
                        paging: true,
                        rowNum: 10,
        ...
        <script type="text/javascript">
            function registrarUsuario() {
                ...
                var object = {
                    txtsocioid: txtsocioid, txtclusteresid: txtclusteresid, txtfechainicio: txtfechainicio, txtfechafin: txtfechafin
                };

                $.ajax({
                    type: "get",
                    url: "agregarResponsable.htm",
                    data: object,
                    dataType: "json",
