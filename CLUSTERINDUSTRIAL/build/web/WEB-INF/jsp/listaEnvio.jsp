        ...
        <div role="main" id="main" class="container_12 clearfix">
            <section id="content" class="container_12 clearfix" data-sort="true">
                <form action="" class="grid_12">
                    <legend>LISTA SUGERENCIA DETALLE</legend> 
        ...
        <script type="text/javascript">
            function getData() {
                $(document).ready(function() {
                    ...
                    $("#list").jqGrid({
                        url: "recuperarEnvio.htm",
                        datatype: 'json',
                        mtype: 'GET',
                        height: 'auto',
                        width: 'auto',
                        colNames: ['NRO', 'ORIGEN', 'DESTINO', 'FEC. SALIDA', 'FEC. LLEGADA', 'TIEMPO ENTREGA', 'CONDUCTOR', 'PERSONAL', 'CELULAR', 'PLACA', 'TIPO VEHICULO', 'OBSERVACION', 'TIPO ENVIO', 'CERTIFICADO'],
                        colModel: [
                            {name: 'envioid', index: 'envioid', width: 50, sortable: false, align: 'left'},
                            {name: 'origen', index: 'origen', width: 80, sortable: false, align: 'left'},
                            {name: 'destino', index: 'destino', width: 80, sortable: false, align: 'left'},
                            {name: 'horasalida', index: 'horasalida', width: 50, sortable: false, align: 'left'},
                            {name: 'horallegada', index: 'horallegada', width: 50, sortable: false, align: 'center'},
                            {name: 'tiempoentrega', index: 'tiempoentrega', width: 100, sortable: false, align: 'center'},
                            {name: 'conductor', index: 'conductor', width: 100, sortable: false, align: 'left'},
                            {name: 'numeropersonal', index: 'numeropersonal', width: 50, sortable: false, align: 'left'},
                            {name: 'numerocelular', index: 'numerocelular', width: 50, sortable: false, align: 'left'},
                            {name: 'placavehiculo', index: 'placavehiculo', width: 50, sortable: false, align: 'left'},
                            {name: 'tipovehiculo', index: 'tipovehiculo', width: 100, sortable: false, align: 'center'},
                            {name: 'observacion', index: 'observacion', width: 100, sortable: false, align: 'center'},
                            {name: 'tipoenvioid', index: 'tipoenvioid', width: 50, sortable: false, align: 'center'},
                        ...
                        caption: "LISTA DE SUGERENCIA DETALLE"
