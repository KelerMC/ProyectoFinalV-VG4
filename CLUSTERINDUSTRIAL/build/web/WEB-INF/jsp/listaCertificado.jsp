...
<html>
    ...
    <body onload="getData();">
        ...
        <div role="main" id="main" class="container_12 clearfix">
            <section id="content" class="container_12 clearfix" data-sort="true">
                <form action="" class="grid_12">
                    ...
                    <legend>LISTA CERTIFICADO PARA SU APROBACION</legend>   
                    <div class="content">
        ...
        <script type="text/javascript">
            function getData() {
                $(document).ready(function() {
                    ...
                    $("#list").jqGrid({
                        url: "recuperarCertificado.htm",
                        datatype: 'json',
                        mtype: 'GET',
                        height: 'auto',
                        width: 'auto',
                        colNames: ['NRO', 'COD. CERTIFICADO.', 'ENT. GARANTE', 'RESPONSABLE', 'NRO. ORDEN', 'FEC. CERTIFICACION', 'CANTIDAD', 'PRECIO UNIT.', 'NETO', 'IGV', 'COSTO TRANS.', 'TOTAL', 'ESTADO'],
                        colModel: [
                            ...
                            {name: 'nombreentidad', index: 'nombreentidad', width: 150, sortable: false, align: 'left'},
                            {name: 'nombrecompleto', index: 'nombrecompleto', width: 150, sortable: false, align: 'left'},
                            ...
                            {name: 'igv', index: 'igv', width: 50, sortable: false, align: 'right'},
                            {name: 'costotrasnporte', index: 'costotrasnporte', width: 80, sortable: false, align: 'right'},
                            {name: 'precioventa', index: 'precioventa', width: 50, sortable: false, align: 'right'},
                            {name: 'estadoresponsable', index: 'estadoresponsable', width: 50, sortable: false, align: 'center', formatter: activoFormatter}
                        ],
                        multiselect: false,
                        paging: true,
                        rowNum: 10,
                        ...
                        ondblClickRow: function(id) {
                            var com = $('#list').getCell(id, "certificadoid");
                            activarCertificado(com);
                        },
                        caption: "LISTA CERTIFICADO PARA SU APROBACION"
        ...
        <script type="text/javascript">
            ...
            function activarCertificado(id) {
                $.ajax({
                    url: "activarCertificado.htm",
                    type: 'get',
                    data: "id=" + id,
                    dataType: "json",
