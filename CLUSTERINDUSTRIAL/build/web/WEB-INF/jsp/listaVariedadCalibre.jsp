<%-- 
    Document   : listaVariedadCalibre
    Created on : 22-feb-2014, 9:07:59
    Author     : ARANGO
--%>
...
<html>
    ...
    <body onload="getData();">
        ...
        <div style="display: none;" id="dialog_add_client" title="Mantenimiento Variedad Calibre">
            <form action="" class="full validate" name="popup" id="popup">
                <div class="row">           
                    ...
                    <div>
                        <select name="txtvariedadid" id="txtvariedadid" class="search" data-placeholder="Seleccione variedad">
                            <c:forEach var="lisVaiedad" items="${listaVaiedad}">
                                <option value="<c:out value="${lisVaiedad.variedadid}"></c:out>"><c:out value="${lisVaiedad.denominacion}"></c:out></option>
                            </c:forEach>
                        </select>
                    </div>
                </div>   
                ...
                <div class="row">           
                    ...
                    <div>
                        <select name="txtcalibresid" id="txtcalibresid" class="search" data-placeholder="Seleccione calibre">
                            <c:forEach var="lisCalibres" items="${listaCalibres}">
                ...
                <div class="row">                    
                    ...
                    <div>
                        <input class="required" type="text" name="txtrango" id="txtrango" />
                    </div>
                </div>  
                ...
                <div class="row">                    
                    ...
                    <div>
                        <input class="required" type="text" name="txtpeso" id="txtpeso" />
                    </div>
                </div>  
        ...
        <div role="main" id="main" class="container_12 clearfix">
            <section id="content" class="container_12 clearfix" data-sort="true">
                <form action="" class="grid_12">
                    <legend>VARIEDAD POR CALIBRE</legend> 
                    <div class="content">
                        <div class="tabletools">
                            <div class="left">
                                <a class="open-add-client-dialog" href="javascript:void(0);"><i class="icon-plus"></i>Nuevo Variedad Calibre</a>
                            </div>                         
                        </div>                        
                    </div>     
                    <table id="list"></table> 
        ...
        <script type="text/javascript">
            function getData() {
                $(document).ready(function() {
                    ...
                    $("#list").jqGrid({
                        url: "recuperarVariedadCalibre.htm",
                        datatype: 'json',
                        mtype: 'GET',
                        height: 'auto',
                        width: 'auto',
        ...
        <script type="text/javascript">
            ...
            function registrar() {
                var object = {
                    variedadid: $('#txtvariedadid').val(),
                    calibresid: $('#txtcalibresid').val(),
                ...
                $.ajax({
                    type: "get",
                    url: "registarVariedadCalibre.htm",
                    data: object,
                    dataType: "json",
                    success: function(response) {
