        ...
        <script type="text/javascript">
            function getData() {
                $(document).ready(function() {
                    ...
                    $("#list").jqGrid({
                        url: "recuperarSugerenciaDetalle.htm",
                        datatype: 'json',
                        mtype: 'GET',
                        height: 'auto',
                        width: 'auto',
                        colNames: ['NRO', 'CLIENTE', 'CLUSTER', 'DESCRIPCION SUGERENCIA', 'FECHA', 'CALIFICACION'],
                        colModel: [
                            {name: 'sugerenciaid', index: 'sugerenciaid', width: 50, sortable: false, align: 'left'},
                            {name: 'nombrecompleto', index: 'nombrecompleto', width: 200, sortable: false, align: 'left'},
                            {name: 'denominacionClu', index: 'denominacionClu', width: 200, sortable: false, align: 'left'},
                            {name: 'textosugerencia', index: 'textosugerencia', width: 300, sortable: false, align: 'left'},
                            {name: 'fechasugerencia', index: 'fechasugerencia', width: 100, sortable: false, align: 'center'},
                            {name: 'clasificacionS', index: 'clasificacionS', width: 100, sortable: false, align: 'center'}
                        ],
                        multiselect: false,
                        paging: true,
                        rowNum: 10,
