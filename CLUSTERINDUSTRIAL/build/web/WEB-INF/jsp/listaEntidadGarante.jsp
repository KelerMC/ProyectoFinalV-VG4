...
<html>
    ...
    <body onload="getData();">
        ...
        <div style="display: none;" id="dialog_add_client" title="Mantenimiento Entidad Garante">
            <form action="" class="full validate" name="popup" id="popup">    
                ...
                <div class="row">
                    ...
                    <div>
                        <input class="required" type="text" name="txtnombreentidad" id="txtnombreentidad" />
                    </div>
                </div>  

                <div class="row">
                    <label for="d2_username">
                        <strong>Telefeno fijo</strong>
                    </label>
                    <div>
                        <input class="required" type="text" name="txttelefenofijo" id="txttelefenofijo" />
                    </div>
                </div>  
                ...
                <div class="row">
                    ...
                    <div>
                        <input class="required" type="text" name="txtrepresentante" id="txtrepresentante" />
                    </div>
                </div>  
                ...
                <div class="row">
                    ...
                    <div>
                        <input class="required" type="text" name="txtcargo" id="txtcargo" />
                    </div>
                </div>  
            </form>
            <div class="actions">
        ...
        <div role="main" id="main" class="container_12 clearfix">
            <section id="content" class="container_12 clearfix" data-sort="true">
                <form action="" class="grid_12">
                    ...
                    <legend>LISTA ENTIDAD GARANTE</legend>   
                    <div class="content">
                        <div class="tabletools">
                            <div class="left">
                                <a class="open-add-client-dialog" href="javascript:void(0);"><i class="icon-plus"></i>Nuevo Entidad Garante</a>
                            </div>                         
                        </div>
                        <table id="list"></table> 
                        <div id="page"></div>
        ...
        <script type="text/javascript">
            function getData() {
                $(document).ready(function() {
                    $("#list").jqGrid({
                        url: "recuperarEntidadGarante.htm",
                        datatype: 'json',
                        height: 'auto',
                        width: 'auto',
                        colNames: ['NRO', 'CLUSTER', 'NOMBRE ENTIDAD', 'TELEFONO FIJO', 'REPRESENTANTE', 'CARGO'],
                        colModel: [
                            {name: 'entidadgaranteid', index: 'entidadgaranteid', width: 50, sortable: false, align: 'center'},
                            {name: 'denominacion', index: 'denominacion', width: 200, sortable: false, align: 'left'},
                            {name: 'nombreentidad', index: 'nombreentidad', width: 200, sortable: false, align: 'left'},
                            {name: 'telefenofijo', index: 'telefenofijo', width: 100, sortable: false, align: 'center'},
                            {name: 'representante', index: 'representante', width: 200, sortable: false, align: 'left'},
                            {name: 'cargo', index: 'cargo', width: 150, sortable: false, align: 'left'}
                        ],
                        multiselect: false,
                        paging: true,
                        rowNum: 10,
        ...
        <script type="text/javascript">
            function registrarUsuario() {
                ...
                var txtnombreentidad = $("#txtnombreentidad").val();
                var txttelefenofijo = $("#txttelefenofijo").val();
                var txtrepresentante = $("#txtrepresentante").val();
                var txtcargo = $("#txtcargo").val();


                var object = {
                    txtclusteresid: txtclusteresid, txtnombreentidad: txtnombreentidad, txttelefenofijo: txttelefenofijo, txtrepresentante: txtrepresentante, txtcargo: txtcargo
                };

                $.ajax({
                    type: "get",
                    url: "insertEntidadGarante.htm",
                    data: object,
                    dataType: "json",
