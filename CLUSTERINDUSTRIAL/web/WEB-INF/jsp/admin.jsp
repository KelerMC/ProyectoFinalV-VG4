    ...
    <aside>
        <div class="top">
            ...
            <nav><ul class="collapsible accordion">
                    ...
                    <li>
                        <a href="javascript:void(0);"><img src="img/icons/packs/fugue/16x16/ui-layered-pane.png" alt="" height="16" width="16" />Menu Principal</a>
                        <ul>
                            <li>
                                <a onclick="ref('listaClusteres.htm');" style="cursor: pointer">
                                    <span class="icon icon-list"></span>Cluster
                                </a>
                            </li>
                            <li>
                                <a onclick="ref('listaAlmacen.htm');" style="cursor: pointer">
                                    <span class="icon icon-cog"></span>Almacen
                                </a>
                            </li>
                            <li>
                                <a onclick="ref('listaVariedad.htm');" style="cursor: pointer">
                                    <span class="icon icon-picture"></span>Variedad
                                </a>
                            </li>
                            <li>
                                <a onclick="ref('listaCalibres.htm');" style="cursor: pointer">
                                    <span class="icon icon-picture"></span>Calibres
                                </a>
                            </li>
                            <li>
                                <a onclick="ref('listaOperacion.htm');" style="cursor: pointer">
                                    <span class="icon icon-picture"></span>Operacion
                                </a>
                            </li>
                            <li>
                                <a onclick="ref('listaSanidad.htm');" style="cursor: pointer">
                                    <span class="icon icon-picture"></span>Sanidad
                                </a>
                            </li>
                            <li>
                                <a onclick="ref('listaVariedadCalibre.htm');" style="cursor: pointer">
                                    <span class="icon icon-list"></span>Variedad Calibre
                                </a>
                            </li>
                            <li>
                                <a onclick="ref('listaEntidadGarante.htm');" style="cursor: pointer">
                                    <span class="icon icon-list"></span>Entidad Garante
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a onclick="ref('registrarProducto.htm');" style="cursor: pointer">
                                    <span class="icon icon-list-alt"></span>Registrar Producto
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a onclick="ref('registrarInventario.htm');" style="cursor: pointer">
                                    <span class="icon icon-list-alt"></span>Registrar Inventario
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a onclick="ref('registrarPersonaSocio.htm');" style="cursor: pointer">
                                    <span class="icon icon-sitemap"></span>Registrar Socio
                                </a>
                            </li>
                            <li>
                                <a onclick="ref('listaResponsable.htm');" style="cursor: pointer">
                                    <span class="icon icon-sitemap"></span>Lista Responsable
                                </a>
                            </li>
                            <li>
                                <a onclick="ref('listaUsuario.htm');" style="cursor: pointer">
                                    <span class="icon icon-sitemap"></span>Lista Usuario
                                </a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a onclick="ref('registrarCertificado.htm');" style="cursor: pointer">Certificado Existencia
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a onclick="ref('registrarEnvio.htm');" style="cursor: pointer">Registro Envio
                                </a>
                            </li>
                            <li>
                                <a onclick="ref('listaEnvio.htm');" style="cursor: pointer">Lista Envio
                                </a>
                            </li>
                        </ul>
                    </li>
